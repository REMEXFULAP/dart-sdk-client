...
class BusinessApi {
  ...
  Future<List<InlineResponse200>> restV1BusinessGet() async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/rest/v1/business".replaceAll("{format}","json");
  ...
  Future<InlineResponse2007> restV1PaymentLinkPost(Body1 body) async {
    ...
    // create path and map variables
    String path = "/rest/v1/payment-link".replaceAll("{format}","json");
